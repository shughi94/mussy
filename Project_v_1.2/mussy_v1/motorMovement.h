const int DIR_1 = 26; //MOTOR 1 IS THE ONE WITH THE DRIVER FURTHER AWAY FROM POWER SUPPLY (ALT MOTOR)
const int STEP_1 = 27;
const int DIR_2 = 18; // (AZ MOTOR)
const int STEP_2 = 19;
const int high_1 = 12;
const int high_2 = 14;
const int high_3 = 33;
